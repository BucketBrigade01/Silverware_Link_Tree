...
function Card() {
  return (
    <div className="absolute flex flex-col justify-center items-center bg-violet-500 h-screen lg:h-96 lg:w-64 scale-75 md:scale-150 rounded-2xl drop-shadow-2xl">
      <img 
      ...
      <a 
        ...
        target="_blank"
        className="relative pb-16 text-amber-400 transform -rotate-6 md:rotate-0 [text-shadow:_1px_1px_0_rgb(213_54_0_/_100%),_3px_2px_0_rgb(0_0_0_/_100%)] font-bold hover:text-orange-500 text-4xl md:text-2xl transition-all duration-200"
      >
        FACEBOOK
      </a>
    </div>
